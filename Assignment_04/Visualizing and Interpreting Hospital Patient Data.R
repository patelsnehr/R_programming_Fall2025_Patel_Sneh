...
# Inspect summary and remove NA values
summary(df_hosp)
df_hosp <- na.omit(df_hosp)

# Side-by-Side Boxplots - save as PNG files
png("Boxplot_BP_by_FirstAssess.png")
...
png("Boxplot_BP_by_SecondAssess.png")
...
png("Boxplot_BP_by_FinalDecision.png")
...
# Histograms - save as PNG files
png("Histogram_Visit_Frequency.png")
